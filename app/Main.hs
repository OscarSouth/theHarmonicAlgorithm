...
main = do
  ...
  let availableTriads1 = (\(_,(x,_,_),_,_,_,_) -> filter (not . (`elem` "()")) $ unlines (filter (not . ("Inv" `List.isInfixOf`)) (show <$> (List.sortBy (compare `on` (\(_,_,(x,_),_) -> x)) $ List.zip4 (sharpTriad <$> triadSets x) (fmap (sharp . pc) <$> triadSets x) (dissonanceLevel <$> triadSets x) (intervalVector <$> triadSets x))))) <$> analysis
  let availableChords1 = (\(_,(x,_,_),_,_,_,_) -> filter (not . (`elem` "()")) $ unlines (show <$> (List.sortBy (compare `on` (\(_,_,(x,_),_) -> x)) $ List.zip4 (sharpChord <$> chordSets x) (fmap (sharp . pc) <$> chordSets x) (dissonanceLevel <$> chordSets x) (intervalVector <$> chordSets x)))) <$> analysis
  let diatonicModes12 = (\(_,_,_,_,_,(x,_,_)) -> filter (not . (`elem` "()")) $ unlines (show <$> (zip (toMode sharp <$> simpleInversions x) ((fmap (sharp . pc)) <$> simpleInversions x)))) <$> analysis
  ...
  let availableTriads2 = (\(_,(_,x,_),_,_,_,_) -> filter (not . (`elem` "()")) $ unlines (filter (not . ("Inv" `List.isInfixOf`)) (show <$> (List.sortBy (compare `on` (\(_,_,(x,_),_) -> x)) $ List.zip4 (sharpTriad <$> triadSets x) (fmap (sharp . pc) <$> triadSets x) (dissonanceLevel <$> triadSets x) (intervalVector <$> triadSets x))))) <$> analysis
  let availableChords2 = (\(_,(_,x,_),_,_,_,_) -> filter (not . (`elem` "()")) $ unlines (show <$> (List.sortBy (compare `on` (\(_,_,(x,_),_) -> x)) $ List.zip4 (sharpChord <$> chordSets x) (fmap (sharp . pc) <$> chordSets x) (dissonanceLevel <$> chordSets x) (intervalVector <$> chordSets x)))) <$> analysis
  let diatonicModes23 = (\(_,_,_,_,_,(_,x,_)) -> filter (not . (`elem` "()")) $ unlines (show <$> (zip (toMode sharp <$> simpleInversions x) ((fmap (sharp . pc)) <$> simpleInversions x)))) <$> analysis
  ...
  let availableTriads3 = (\(_,(_,_,x),_,_,_,_) -> filter (not . (`elem` "()")) $ unlines (filter (not . ("Inv" `List.isInfixOf`)) (show <$> (List.sortBy (compare `on` (\(_,_,(x,_),_) -> x)) $ List.zip4 (sharpTriad <$> triadSets x) (fmap (sharp . pc) <$> triadSets x) (dissonanceLevel <$> triadSets x) (intervalVector <$> triadSets x))))) <$> analysis
  let availableChords3 = (\(_,(_,_,x),_,_,_,_) -> filter (not . (`elem` "()")) $ unlines (show <$> (List.sortBy (compare `on` (\(_,_,(x,_),_) -> x)) $ List.zip4 (sharpChord <$> chordSets x) (fmap (sharp . pc) <$> chordSets x) (dissonanceLevel <$> chordSets x) (intervalVector <$> chordSets x)))) <$> analysis
  let diatonicModes31 = (\(_,_,_,_,_,(_,_,x)) -> filter (not . (`elem` "()")) $ unlines (show <$> (zip (toMode sharp <$> simpleInversions x) ((fmap (sharp . pc)) <$> simpleInversions x)))) <$> analysis
