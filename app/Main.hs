...
import System.IO
-- import qualified Data.Vector.SEXP as Vect
import qualified Foreign.R as R
import qualified Language.R.Literal as R 
-- import qualified Language.R.HExp as R
...
initScript = do  
  putStrLn ""
  putStrLn "___________________________________________________________________________\n"
...
-- rData'  :: () -> IO [Double]
rData' () = do
  runRegion $ R.fromSomeSEXP <$> [r| list(1,2,3) |]
